var app = ( function() {
	...
	function initModels() {
		// Zeppelin using base models with multiple cylinder und spheres
		var fs = "fill";
		createModel("plane", fs, [1, 1, 1, 1], [0, -0.8, 0], [0, 0, 0], [1, 1, 1]);

		createModel("sphere", fs, [1, 1, 1, 1], [-0.5, 1, 0], [0, Math.PI/2, 0], [1, 1, 1]);
		createModel("cylinder", fs, [1, 1, 1, 1], [-0.5, 1, 0], [0, Math.PI/2, 0], [1, 1, 1]);
		createModel("sphere", fs, [1, 1, 1, 1], [0.5, 1, 0], [0, Math.PI/2, 0], [1, 1, 1]);

		createModel("sphere", fs, [1, 1, 1, 1], [0, 0, 0], [0, Math.PI/2, 0], [0.15, 0.15, 0.15]);
